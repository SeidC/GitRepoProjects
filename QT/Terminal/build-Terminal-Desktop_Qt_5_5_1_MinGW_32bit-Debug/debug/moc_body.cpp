...
#include "../../Application/Sources/Tp/body.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Body_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Body_t qt_meta_stringdata_Body = {
    {
QT_MOC_LITERAL(0, 0, 4) // "Body"
...
const QMetaObject Body::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Body.data,
      qt_meta_data_Body,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Body::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Body.stringdata0))
