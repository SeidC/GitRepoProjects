...
$DataList = GUICtrlCreateListView("", 88, 200, 514, 254, BitOR($LVS_REPORT,$LVS_SHOWSELALWAYS))
GUICtrlSetFont(-1, 8, 400, 0, "Verdana")
GUICtrlSetResizing(-1, $GUI_DOCKAUTO+$GUI_DOCKLEFT+$GUI_DOCKRIGHT+$GUI_DOCKTOP)
$StopButton = GUICtrlCreateButton("Stop", 8, 392, 75, 25)
GUICtrlSetFont(-1, 8, 400, 0, "Verdana")
$StartButton = GUICtrlCreateButton("Start Download", 8, 328, 75, 57, $BS_MULTILINE)
GUICtrlSetFont(-1, 8, 400, 0, "Verdana")
...
$Label2 = GUICtrlCreateLabel("URL Modified:", 212, 88, 82, 17, BitOR($SS_CENTER,$SS_CENTERIMAGE))
GUICtrlSetFont(-1, 8, 400, 0, "Verdana")
$ParameterInput1 = GUICtrlCreateInput("", 288, 120, 49, 21)
$FromToInput1 = GUICtrlCreateInput("", 416, 120, 89, 21)
$Label3 = GUICtrlCreateLabel("Parameter:", 212, 120, 69, 17, $SS_CENTERIMAGE)
GUICtrlSetFont(-1, 8, 400, 0, "Verdana")
$Label4 = GUICtrlCreateLabel("Reagion:", 352, 120, 55, 17, $SS_CENTERIMAGE)
GUICtrlSetFont(-1, 8, 400, 0, "Verdana")
$ParameterInput2 = GUICtrlCreateInput("", 288, 152, 49, 21)
$Label5 = GUICtrlCreateLabel("Parameter:", 212, 152, 69, 17, $SS_CENTERIMAGE)
GUICtrlSetFont(-1, 8, 400, 0, "Verdana")
$Label6 = GUICtrlCreateLabel("Reagion:", 352, 152, 55, 17, $SS_CENTERIMAGE)
GUICtrlSetFont(-1, 8, 400, 0, "Verdana")
...
$Label7 = GUICtrlCreateLabel("Save to Folder:", 212, 88, 92, 17, BitOR($SS_CENTER,$SS_CENTERIMAGE))
GUICtrlSetFont(-1, 8, 400, 0, "Verdana")
