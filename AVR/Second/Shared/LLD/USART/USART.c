 ...
 **************************************************************************************************/
void USART_ReceiveString(char *str, uint8_t size)
{
 ...
 *************************************************************************************************/
void USART_ReceiveData(uint8_t* str, uint8_t size)
{
    FIFO_ReadString(&USART_rxBuffer,(char*)str,size);
    return;
}
