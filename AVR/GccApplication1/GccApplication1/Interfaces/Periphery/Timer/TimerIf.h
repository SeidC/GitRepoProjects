...
public:
	...
	virtual void setTimerMode(Tccr8::TimerMode_e tmode) = 0;
	virtual void setOutputMode(Tccr8::OutputMode_e omode) = 0;
	virtual void setPreScaler(Tccr8::Prescaler_e prescaler) = 0;
	virtual Tccr8::Prescaler_e getPrescaler(void) = 0;
