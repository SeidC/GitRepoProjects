...
#include "../../Application/Sources/Tp/footer.h"
...
const QMetaObject Footer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Footer.data,
      qt_meta_data_Footer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *Footer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Footer.stringdata0))
        return static_cast<void*>(const_cast< Footer*>(this));
